    ...
    .controller('FormController', function($scope, $http) {
        ...
        $scope.formDefinition = [
            ...
            },
            {
                ...
                fields: [
                    ...
                    [
                        ...
                        {name: 'state', value: '', class: 'col-md-2', type: 'text', trim: true, maxlength: 2, placeholder: 'State'},
                        {name: 'zip', value: '', class: 'col-md-2', type: 'text', trim: true, maxlength: 10, placeholder: 'ZIP Code'},
                        {name: 'okayToMail', class: 'col-md-2', type: 'boolean', placeholder: 'OK To Mail?', value: false}
                    ],
                    [
                        {name: 'email', value: '', class: 'col-md-10', type: 'email', trim: true, maxlength: 255, placeholder: 'Email'},
                        {name: 'okayToEmail', class: 'col-md-2', type: 'boolean', placeholder: 'OK To Email?', value: false}
                    ],
                    [
                        {name: 'cellPhone', value: '', class: 'col-md-2', type: 'phone', trim: true, maxlength: 10, placeholder: 'Cell Number'},
                        {name: 'okayToCallCell', class: 'col-md-2', type: 'boolean', placeholder: 'Message OK?', value: false},
                        {name: 'okayToCallCellLVM', class: 'col-md-2', type: 'boolean', placeholder: 'LVM OK?', value: false},
                        {name: 'homePhone', value: '', class: 'col-md-2', type: 'phone', trim: true, maxlength: 10, placeholder: 'Home Number'},
                        {name: 'okayToCallHome', class: 'col-md-2', type: 'boolean', placeholder: 'Message OK?', value: false},
                        {name: 'okayToCallHomeLVM', class: 'col-md-2', type: 'boolean', placeholder: 'LVM OK?', value: false}
                    ],
                    [
                        {name: 'workPhone', value: '', class: 'col-md-2', type: 'phone', trim: true, maxlength: 10, placeholder: 'Work Number'},
                        {name: 'okayToCallWork', class: 'col-md-2', type: 'boolean', placeholder: 'Message OK?', value: false},
                        {name: 'okayToCallWorkLVM', class: 'col-md-2', type: 'boolean', placeholder: 'LVM OK?', value: false},
                        {name: 'alternatePhone', value: '', class: 'col-md-2', type: 'phone', trim: true, maxlength: 10, placeholder: 'Alternate Number'},
                        {name: 'okayToCallAlternate', class: 'col-md-2', type: 'boolean', placeholder: 'Message OK?', value: false},
                        {name: 'okayToCallAlternateLVM', class: 'col-md-2', type: 'boolean', placeholder: 'LVM OK?', value: false},
                    ],
                    [
                        {name: 'emergencyContactName', value: '', class: 'col-md-8', type: 'text', trim: true, maxlength: 255, placeholder: 'Emergency Contact (Name)'},
            ...
            },
            {
                ...
                fields: [
                	[
                		...
                		{name: 'ishispanic', class: 'col-md-2', type: 'boolean', placeholder: 'Hispanic?', value: false},
				     ...
				     {name: 'partime', class: 'col-md-2', value: '', type: 'checkbox', trim: true, placeholder: 'Part-Time'},
				      {name: 'multiplejobs', class: 'col-md-2', value: '', type: 'checkbox', trim: true, placeholder: 'Multiple Jobs?'},
				       {name: 'temporaryjobs', class: 'col-md-2', value: '', type: 'checkbox', trim: true, placeholder: 'Temporary Jobs(s)?'},
				        {name: 'recentlayoff', class: 'col-md-6', value: false, type: 'boolean', trim: true, placeholder: 'Recent Layoff?'},
				         {name: 'concernlayoff', class: 'col-md-6', value: false, type: 'boolean', trim: true, placeholder: 'Concern Re: Recent Layoff?'},
				          {name: 'tafdc', class: 'col-md-12', value: false, type: 'boolean', trim: true, placeholder: 'Public Assistance: Transitional Aid to Families with Dependent Children?'},
				           {name: 'eaedc', class: 'col-md-12', value: false, type: 'boolean', trim: true, placeholder: 'Public Assistance: Emergency Assistance to Elderly, Disabled and Children?'},
				            {name: 'snap', class: 'col-md-12', value: false, type: 'boolean', trim: true, placeholder: 'Public Assistance: Supplemental Nutrition Assistance Program or Food Stamps?'},
				             {name: 'ea', class: 'col-md-12', value: false, type: 'boolean', trim: true, placeholder: 'Public Assistance: Emergency Assistance?'},
				              {name: 'ssi', class: 'col-md-12', value: false, type: 'boolean', trim: true, placeholder: 'Public Assistance: Supplimental Security Income?'},
				               {name: 'wic', class: 'col-md-12', value: false, type: 'boolean', trim: true, placeholder: 'Public Assistance: Women, Infants, and Childrens Programs?'},
            ...
            },
            {
                ...
                fields: [
                [
                {name: 'havecomputer', class: 'col-md-3', value: false, type: 'boolean', trim: true, placeholder: 'Do you have a computer at home?'},
                {name: 'usesmartphone', class: 'col-md-3', value: false, type: 'boolean', trim: true, placeholder: 'Do you use a smart phone?'},
                {name: 'usecomputer', class: 'col-md-3', value: false, type: 'boolean', trim: true, placeholder: 'Do you use a computer at home?'},
                {name: 'useemail', class: 'col-md-3', value: false, type: 'boolean', trim: true, placeholder: 'Do you use email?'},
                {name: 'usecomputeratlibrary', class: 'col-md-3', value: false, type: 'boolean', trim: true, placeholder: 'Do you use a computer at the library?'},
                {name: 'useinternet', class: 'col-md-3', value: false, type: 'boolean', trim: true, placeholder: 'Do you use the Internet?'},
                {name: 'usecomputeratwork', class: 'col-md-3', value: false, type: 'boolean', trim: true, placeholder: 'Do you use a computer at work?'}
				],
                ]
            },
			{
                ...
                fields: [
                [
				{name: 'understanddisclosure', class: 'col-md-12', value: false, type: 'boolean', trim: true, placeholder: 'Does the Student understand that He/She is not required to disclose a disability?'},
				{name: 'wishtodisclose', class: 'col-md-12', value: false, type: 'boolean', trim: true, placeholder: 'Does the Student wish to disclose a disability?'},
				{name: 'understandaccommodations', class: 'col-md-12', value: false, type: 'boolean', trim: true, placeholder: 'Does the student understand that self-disclosing a disability makes him/her eligible for reasonable accommoations?'},
				{name: 'requestanyspecific', class: 'col-md-12', value: false, type: 'boolean', trim: true, placeholder: 'If Yes to #3, Does the student wish to request any specific accomodations? If yes, Please explain below in the notes.'},
				{name: 'intervierwerobservations', class: 'col-md-12', value: false, type: 'boolean', trim: true, placeholder: 'Does the interviewer observe anything?'},
            ...
            },
            {
				...
				{name: 'LVM_Referal', class: 'col-md-12', value: '', type: 'dropdown', options: [{name: 'ABE Center', value: 1},{name: 'Brochure, Flyer, Poster', value: 2},{name: 'church', value: 3},{name: 'Community Center / Meeting', value: 4},{name: 'Coordinator', value: 5},{name: 'Employer', value: 6},{name: 'Family', value: 7},{name: 'Friend', value: 8},{name: 'Hospital', value: 9},
